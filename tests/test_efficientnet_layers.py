...
@pytest.mark.parametrize(
    ...
    [
        (1, 3, 1, 32, 16, 1, 0.0, 112, 112),
        (6, 3, 2, 16, 24, 2, 0.0125, 112, 112),
        (6, 3, 1, 24, 24, 2, 0.025, 56, 56),
        (6, 5, 2, 24, 40, 2, 0.0375, 56, 56),
        (6, 5, 1, 40, 40, 2, 0.05, 28, 28),
        (6, 3, 2, 40, 80, 3, 0.0625, 28, 28),
        (6, 3, 1, 80, 80, 3, 0.075, 14, 14),
        (6, 3, 1, 80, 80, 3, 0.0875, 14, 14),
        (6, 5, 1, 80, 112, 3, 0.1, 14, 14),
        (6, 5, 1, 112, 112, 3, 0.1125, 14, 14),
        (6, 5, 1, 112, 112, 3, 0.125, 14, 14),
        (6, 5, 2, 112, 192, 4, 0.1375, 14, 14),
        (6, 5, 1, 192, 192, 4, 0.15, 7, 7),
        (6, 5, 1, 192, 192, 4, 0.1625, 7, 7),
        (6, 5, 1, 192, 192, 4, 0.175, 7, 7),
        (6, 3, 1, 192, 320, 1, 0.1875, 7, 7),
    ],
)
